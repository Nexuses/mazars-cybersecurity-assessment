export const translations = {
  en: {
    ...
    thankYou: {
      title: "Thank You!",
      message: "Thank you for completing the Cybersecurity Self-Assessment. We have received your assessment results and will review them carefully.",
      followUp: "Our team will get back to you within 2-3 business days with a detailed analysis and personalized recommendations based on your assessment.",
      contact: "If you have any immediate questions or concerns, please don't hesitate to reach out to us."
    },
    pdfLabels: {
      personalInfo: "Personal Information",
      name: "Name",
  ...
  fr: {
    ...
    thankYou: {
      title: "Merci !",
      message: "Merci d'avoir complété l'auto-évaluation de cybersécurité. Nous avons reçu vos résultats d'évaluation et les examinerons attentivement.",
      followUp: "Notre équipe vous recontactera dans les 2-3 jours ouvrables avec une analyse détaillée et des recommandations personnalisées basées sur votre évaluation.",
      contact: "Si vous avez des questions ou des préoccupations immédiates, n'hésitez pas à nous contacter."
    },
    pdfLabels: {
      personalInfo: "Informations Personnelles",
      name: "Nom",
